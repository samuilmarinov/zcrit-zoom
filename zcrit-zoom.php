...
function run_zcrit_zoom()
{
    ...
    {   
        ...
        $current_user = wp_get_current_user();
        $current_user_id = $current_user->ID;
        add_user_meta( $current_user_id, 'zxzzoomactive_'.$current_user_id.'_user', $zommmail_ext, true);
        add_user_meta( $current_user_id, 'zxzzoomactive_'.$current_user_id.'_user_pass', $zommpass_ext, true); 
        ob_start();
